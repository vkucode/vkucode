    ...
    return(
        <>
            <section className={styles.headerAccueil}>
                <div className='w-screen overflow-x-hidden h-[50vh] lg:h-[60vh] pt-20 animate__animated animate__fadeInUp flex flex-col justify-center items-center'>
                    <h1>
                        for&nbsp;us&nbsp;the&nbsp;sky<br />
                ...
                <div className={styles.textHeader}>
                    ...
                    <div className='flex flex-col-reverse lg:flex-row justify-center items-center'>
                        <div className={`${styles.carteImgs} animate__animated animate__fadeInLeft`}>
                            <Image src="/img/accueil/header/carte.png" width={400} height={400} alt='vkucode' />
                            <Image src="/img/accueil/header/cartelogo.png" alt='vkucode' className='absolute top-0 left-0 hover:-rotate-12 transition-all ease-in-out duration-300' width={350} height={350} />
                        </div>
