...
const MockUpVku = () => (
    <div className="relative bottom-0 left-0 h-[340px] w-full rounded-xl  sm:h-[370px]">
      <div className="relative">
        <Image className="relative w-full max-w-[250px] z-20" src="/img/accueil/header/carteciffre.png" width={500} height={500} alt="kasperVKU" />
        <Image className="absolute z-30 top-5 w-full max-w-[220px]" src="/img/accueil/header/cartekasper.png" width={500} height={500} alt="kasperVKU"/>
        <Image className="absolute z-10 w-full max-w-[150px] right-0 bottom-20" src="/img/accueil/header/cartevku.png" width={500} height={500} alt="vkucode" />
      </div>
    </div>
);
